...
1. **Skill evaluation**: Use `/evaluating-skills` on new/modified skills
2. **Version check**: Run `verify-release-readiness` skill
3. **Validation scripts**: Check that skills pass structure validation
4. **Documentation**: Update skills/README.md and plugins/README.md
